...
public class DisplayColors {
    ...
    protected ComplimentaryColorPanel complementaryColorPanel;
	...
	complementaryColorPanel = new ComplimentaryColorPanel(Color.getHSBColor((float).5, (float).5, (float).5), hueSlider, saturationSlider, brightnessSlider);
