		...
		try {
			...
			if (words.length == 1) {
				...
				if (words[0].equalsIgnoreCase("help")) {
					...
					SB.append("\r\n2. Type <studentID> to get exam results for the student ID.");
				...
				//This command will subscribe a particular GTalk user to minor and major status of ExamResults
					...
					strCallResult = "Student ID : " + ER.getId().getName() + "\r\n";
					strCallResult += "Student Name : " + ER.getName() + "\r\n";
					strCallResult += "Exam 1 : " + ER.getExam1Grade() + "\r\n";
					strCallResult += "Exam 2 : " + ER.getExam2Grade() + "\r\n";
					strCallResult += "=================================" + "\r\n";
